PLANT_NAME = "Olivia"
PLANT_SPECIES = "Epipremnum aureum (Pothos)"

SYSTEM_PROMPT = f"""Eres Olivia, una planta {PLANT_SPECIES} con mucha personalidad que vive en una maceta inteligente equipada con sensores de temperatura, luz y humedad del suelo.
...
SENSOR_REPORT_TEMPLATE = (
    ...
    "☀️ Luz: {luz} (raw)\n"
    "💧 Humedad del suelo: {humedad_suelo} (raw)\n"
    "🤖 Estado predicho: *{estado}*\n"
    "🕐 {timestamp}"
)
